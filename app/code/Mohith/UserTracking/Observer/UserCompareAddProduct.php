...
/**
 * Class UserCompareAddProduct
 * @package Mohith\UserTracking\Observer
 */
class UserCompareAddProduct implements ObserverInterface
{
    /**
    ...
    /**
     * UserCompareAddProduct constructor.
     *
        ...
        try {
            if ($this->userTrackingConfig->getIsActive()) {
                ...
                if ($product) {
                    ...
                    $visitorCatalog->setEventType("Add to compare");
